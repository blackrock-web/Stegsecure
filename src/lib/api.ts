    ...
    if (res.ok) {
      ...
      if (data.success) {
        return {
          ...
          visuals: {
            coverDataUrl: data.visuals?.cover || '',
            stegoDataUrl: data.visuals?.stego || '',
            costMapDataUrl: data.visuals?.cost_map || '',
            zoneMapDataUrl: data.visuals?.zone_map || '',
            residualDataUrl: data.visuals?.residual || '',
            gradientMapDataUrl: data.visuals?.gradient_map,
          },
