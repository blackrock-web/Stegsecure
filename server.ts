...
app.post('/api/benchmark', (req: Request, res: Response) => {
  res.json({
    ...
    image_count: parseInt((req.body.max_images as string) || '3', 10),
    ...
    metrics: [
      ...
      },
      {
        ...
        ssim_mean: 0.9982,
        bpp: 0.38,
        stego_detection_rate: 0.16,
        latency_ms: 24,
      },
      {
        strategy: 'Baseline: Standard OPAP (Chan & Cheng 2004)',
        psnr_mean: 54.6,
        ssim_mean: 0.9945,
        bpp: 0.66,
        stego_detection_rate: 0.32,
        latency_ms: 18,
      },
      {
        strategy: 'Baseline: Sequential LSB',
        psnr_mean: 51.1,
        ssim_mean: 0.989,
        bpp: 1.0,
        stego_detection_rate: 0.88,
        latency_ms: 12,
      },
    ],
  });
...
// Ablation endpoint
app.post('/api/ablation', (req: Request, res: Response) => {
  res.json({
    timestamp: new Date().toISOString(),
    ablations: [
      {
